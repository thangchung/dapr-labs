...
public class Order
{
    ...
    public Order Apply(OrderUp orderUp)
    {
        ...
        // Console.WriteLine($"XXXXXXX-orderUp-{JsonConvert.SerializeObject(orderUp.ItemLineId)}");
        // Console.WriteLine($"XXXXXXX-ItemLines-{JsonConvert.SerializeObject(ItemLines)}");
        // Console.WriteLine($"XXXXXXX-{JsonConvert.SerializeObject(item)}");
        if (item is not null)
        {
            // Console.WriteLine("RUN TO UPDATING TO ITEM_FULFILLED");
        ...
        {
            Console.WriteLine("============= RUN TO UPDATING TO ORDER-FULFILLED");
